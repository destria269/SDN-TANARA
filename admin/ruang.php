...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                             Tambah Kelas <small></small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="index.php">Beranda</a></li>
					  <li><a href="#">Ruangan Kelas</a></li>
        ...
        <form action="ruang/aksi_ruang.php" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="kd_ruang" placeholder="MASUKAN TAHUN AJAR" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="kd_ruang" placeholder="MASUKAN KODE RUANG KELAS" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="nama_ruang" placeholder="MASUKAN NAMA RUANG KELAS" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
