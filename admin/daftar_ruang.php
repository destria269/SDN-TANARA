        ...
        <div id="page-wrapper">
		  <div class="header"> 
            ...
            <div class="panel-tools">
                ...
                <a class="btn btn-success pull-right" href="ruang.php">Tambah Data</a>
            </div>
        </div>
            <div id="page-inner"> 
...
<!-- End Feedback -->
    <div class="box box-success">
        <form action="aksi_ruang.php" method="POST" class="form-horizontal">
            ...
            <tbody>
                    ...
                    include '../koneksi.php';
                    $data=mysqli_query($koneksi,"SELECT * from ruang
                        INNER JOIN guru ON ruang.nip = guru.nip
                        ");
                    $i=0;
                    while($d=mysqli_fetch_array($data)){ 
                        $i++;
                    ...
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <a name="hapus" href="ruang/hapus_ruang.php?kd_ruang=<?php echo $d['kd_ruang'];?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-info btn-sm">HAPUS</a>
