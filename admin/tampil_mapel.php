...
<!-- End Feedback -->
    <div class="box box-success">
        <form action="mapel/update_mapel.php" method="POST" class="form-horizontal">
            ...
            <div class="box-header with-border">
                ...
                <?php
                    ...
                    $data=mysqli_query($koneksi,"Select * from mapel where kd_mapel='$kd_mapel'");
            ...
            <div class="form-group">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="kd_mapel" value="<?php echo $d['kd_mapel']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="nama_mapel" value="<?php echo $d['nama_mapel']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="kkm" value="<?php echo $d['kkm']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
