    ...
    <div id="page-wrapper">
        <div class="header"> 
                        <h1 class="page-header">
                           Pendaftaran Guru <small>Selamat Datang</small>
                        </h1>
                        <ol class="breadcrumb">
            ...
            <div class="panel-tools">
                ...
                <a class="btn btn-success pull-right" href="guru.php">Tambah Data</a>
            </div>
        </div>
            <div id="page-inner"> 
...
<!-- End Feedback -->
    <div class="box box-success">
        <form action="aksi_guru.php" method="POST" class="form-horizontal">
            ...
            <div class="box-header with-border">
               <table class="table" id="datatables"><thead>
                <tr>
                    ...
                    <th><center>NOMER TELEPON</center></th>
                    <th><center>BIDANG YANG DIAMPU</center></th>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a class="btn btn-info btn-sm" href="tampil_guru.php?nip=<?php echo $d['nip'];?>" >EDIT</a>

                            <a name="hapus" href="guru/hapus_guru.php?nip=<?php echo $d['nip'];?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-info btn-sm">HAPUS</a>
                        </td>
                    </tr>
                <?php } ?> 
            </tbody>
