...
<body>
    <div id="wrapper">
        ...
        <div class="row">
        <form action="daftarsiswa/aksi_siswa.php" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="xZ2VSYLghz35eFPpNTTE3urshSALQ7GX4EWtDh4l">
            <div class="box-header with-border">
                <h3 class="box-title" >Tambah Daftar Kelas Siswa</h3>
            </div><br><br>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
                    NIM
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" id="form-field-1" name="nip">
                            <option value="">--- NIM Siswa --</option>
                             <?php
                            include '../koneksi.php';
                            $data = mysqli_query($koneksi, "SELECT * FROM siswa");
                            while($d = mysqli_fetch_array($data)) {
                                    echo '<option value="'.$d['nis'].'">'.$d['nis'].'</option>';
                                }
                            ?>
                        </select>
                    </div>
                    ...
                    Jenis Kelamin
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control col-md-7 col-xs-12" id="form-field-1" name="kd_ruang">
                            ...
                            $data = mysqli_query($koneksi, "SELECT * FROM siswa");
                            while($d = mysqli_fetch_array($data)) {
                                    echo '<option value="'.$d['nis'].'">'.$d['gender'].'</option>';
                                }
                            ?>
                        </select>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="data_daftarsiswa.php" class="btn btn-info btn-sm">Kembali</a>               
                </div>
            </div>
         </form>
    </div>
