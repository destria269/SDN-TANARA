        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                           Daftar Kelas Siswa <small></small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="index.php">Beranda</a></li>
					  <li><a href="#">Daftar Kelas Siswa</a></li>
        ...
        <form action="ruang/update_ruang.php" method="POST" class="form-horizontal">
            ...
            <div class="box-header with-border">
                ...
                <?php
                    ...
                    $data=mysqli_query($koneksi,"Select * from ruang where kd_kelas='$kd_kelas'");
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="kd_kelas" value="<?php echo $d['kd_kelas']?>" id="form-field-1" class="form-control" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
                ...
                <div class="col-sm-9">
                    <input type="text" name="nama_kelas" value="<?php echo $d['nama_kelas']?>" id="form-field-1" class="form-control" required>
                </div>
            </div>
