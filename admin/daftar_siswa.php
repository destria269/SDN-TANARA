       ...
       <!--/. NAV TOP  -->
        ...
        <div id="page-wrapper">
          <div class="header"> 
            <h1 class="page-header">
                Daftar Kelas Siswa <small>Selamat Datang</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <form action="daftarsiswa/aksi_siswa.php" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="data_daftarsiswa.php" class="btn btn-danger btn-sm">Tampil</a>
                </div>
                <div class="col-sm-1">
                    <a href="daftar_jadwal.php" class="btn btn-info btn-sm">Cetak</a>               
                </div>
            </div>
         </form>
    </div>
