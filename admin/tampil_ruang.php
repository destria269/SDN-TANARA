            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="daftar_ruang.php"  class="active-menu"><i class="fa fa-sitemap"></i>Kelas</a>  
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                           Ruangan Kelas <small></small>
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="index.php">Beranda</a></li>
					  <li><a href="#">Edit Ruangan Kelas</a></li>
...
<!-- End Feedback -->
    <div class="box box-success">
        <form action="ruang/update_ruang.php" method="POST" class="form-horizontal">
            ...
            <div class="box-header with-border">
                ...
                <?php
                    ...
                    $data=mysqli_query($koneksi,"Select * from ruang where kd_ruang='$kd_ruang'");
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="thnajar" value="<?php echo $d['thnajar']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="kd_ruang" value="<?php echo $d['kd_ruang']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" name="nama_ruang" value="<?php echo $d['nama_ruang']?>" id="form-field-1" class="form-control col-md-7 col-xs-12" required>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form-field-1">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="daftar_ruang.php" class="btn btn-info btn-sm">Kembali</a>               
                </div>
            </div>
