...
<table>
    <tr>
      ...
      <td align="center" style="width: 800px;"><font style="font-size: 20px"><br><b>JADWAL PELAJARAN</b></font>
        ...
        <table class="table table-striped table-bordered" border="1" cellspacing="0">
          <thead>
            <tr>
                    ...
                    <th style="width: 300px;"><font style="font-size: 14px"><center>Nama Guru</center></th>
          ...
          <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><?php echo $d['nama_guru']?></td>
