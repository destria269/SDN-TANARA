    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="header"> 
                      ...
                      <li><a href="#">Edit Jenis Syarat</a></li>
...
<!-- End Feedback -->
    <div class="box box-success">
        <form action="harga/edit_harga.php" method="POST" class="form-horizontal">
            <input type="hidden" name="_token" value="xZ2VSYLghz35eFPpNTTE3urshSALQ7GX4EWtDh4l">
            <div class="box-header with-border">
                <h3 class="box-title">Kelengkapan Persyaratan</h3>
            </div><br><br>

                <?php
                    include '../koneksi.php';
                    $id=$_GET['id'];
                    $data=mysqli_query($koneksi,"Select * from syarat where id='$id'");
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" name="id" value="<?php echo $d['id']?>" id="form-field-1" class="form-control" readonly>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
                ...
                <div class="col-sm-9">
                    <input type="text" name="jenis" value="<?php echo $d['jenis']?>" id="form-field-1" class="form-control" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
                ...
                <div class="col-sm-9">
                    <input type="text" name="qty" value="<?php echo $d['qty']?>" id="form-field-1" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <a href="daftar_syarat.php" class="btn btn-info btn-sm">Kembali</a>               
                </div>
            </div>
